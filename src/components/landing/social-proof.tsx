...
const benefits = [
  "200 RECEITAS RÁPIDAS E DELICIOSAS",
  "RECEITAS DE ATÉ 350 CALORIAS",
  "ACESSO IMEDIATO VIA E-MAIL + WHATSAPP",
];

const bonuses = [
  "BÔNUS: 100 RECEITAS LOW CARB",
  "BÔNUS: MINI GUIA DETOX 3 DIAS",
  "BÔNUS: DESAFIO 7 DIAS FAST FIT",
];
